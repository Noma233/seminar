...
int kernel(int n, double rix[], double riy[], double riz[], double rjx[], double rjy[], double rjz[], double eps2[], double fx[], double fy[], double fz[], double p[]){
   ...
   for (i = 0; i < n; i += 4) {
      ...
      for (j = 0; j < n; j += 1) {
         ...
         r2_tmp = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(eps2_tmp, _mm256_mul_pd(dx_tmp, dx_tmp)), _mm256_mul_pd(dy_tmp, dy_tmp)), _mm256_mul_pd(dz_tmp, dz_tmp));
         r2_inv_tmp = _mm256_div_pd(float_4_tmp, _mm256_sqrt_pd(r2_tmp));
         r2_inv3_tmp = _mm256_mul_pd(r2_inv_tmp, _mm256_mul_pd(r2_inv_tmp, r2_inv_tmp));
         r2_inv6_tmp = _mm256_mul_pd(r2_inv3_tmp, r2_inv3_tmp);
         f_tmp = _mm256_mul_pd(_mm256_mul_pd(r2_inv3_tmp, _mm256_mul_pd(r2_inv_tmp, r2_inv_tmp)), _mm256_sub_pd(_mm256_mul_pd(float_1_tmp, r2_inv6_tmp), float_2_tmp));
         fx_tmp += _mm256_mul_pd(dx_tmp, f_tmp);
         fy_tmp += _mm256_mul_pd(dy_tmp, f_tmp);
         fz_tmp += _mm256_mul_pd(dz_tmp, f_tmp);
         p_tmp += _mm256_mul_pd(_mm256_mul_pd(float_3_tmp, r2_inv6_tmp), _mm256_sub_pd(r2_inv6_tmp, float_4_tmp));
      };
