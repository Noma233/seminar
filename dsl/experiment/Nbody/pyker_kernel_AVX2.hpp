...
int kernel(int n, double ri[][3], double rj[][3], double mass[], double eps2[], double ai[][3]){
   ...
   for (i = 0; i < n; i += 4) {
      ...
      for (j = 0; j < n; j += 1) {
         ...
         r2_tmp = _mm256_add_pd(eps2_tmp, _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(rij_tmp_v0, rij_tmp_v0), _mm256_mul_pd(rij_tmp_v1, rij_tmp_v1)), _mm256_mul_pd(rij_tmp_v2, rij_tmp_v2)));
