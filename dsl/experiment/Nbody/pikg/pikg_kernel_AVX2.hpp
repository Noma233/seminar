...
ai.v0 = _mm256_set1_pd(0.0);
ai.v1 = _mm256_set1_pd(0.0);
ai.v2 = _mm256_set1_pd(0.0);
for(j = 0;j < (nj/1)*1;++j){
__m256d eps2;
...
rij.v0 = _mm256_sub_pd(ri.v0,rj.v0);
rij.v1 = _mm256_sub_pd(ri.v1,rj.v1);
rij.v2 = _mm256_sub_pd(ri.v2,rj.v2);
__fkg_tmp1 = _mm256_fmadd_pd(rij.v0,rij.v0,eps2);
__fkg_tmp0 = _mm256_fmadd_pd(rij.v1,rij.v1,__fkg_tmp1);
r2 = _mm256_fmadd_pd(rij.v2,rij.v2,__fkg_tmp0);
r_inv = rsqrt(r2);
r2_inv = _mm256_mul_pd(r_inv,r_inv);
mr_inv = _mm256_mul_pd(mj,r_inv);
mr3_inv = _mm256_mul_pd(r2_inv,mr_inv);
ai.v0 = _mm256_fmadd_pd(mr3_inv,rij.v0,ai.v0);
ai.v1 = _mm256_fmadd_pd(mr3_inv,rij.v1,ai.v1);
ai.v2 = _mm256_fmadd_pd(mr3_inv,rij.v2,ai.v2);
} // loop of j

{
__m256d __fkg_tmp_accum;
alignas(32) int index_gather_load3[4] = {0,3,6,9};
__m128i vindex_gather_load3 = _mm_load_si128((const __m128i*)index_gather_load3);
__fkg_tmp_accum = _mm256_i32gather_pd(((double*)&force[i+0].acc.x),vindex_gather_load3,8);
__fkg_tmp_accum = _mm256_add_pd(__fkg_tmp_accum,ai.v0);
{
PIKG::F64 __fkg_store_tmp[4];
_mm256_storeu_pd(__fkg_store_tmp,__fkg_tmp_accum);
((double*)&force[i+0].acc.x)[0] = __fkg_store_tmp[0];
((double*)&force[i+0].acc.x)[3] = __fkg_store_tmp[1];
((double*)&force[i+0].acc.x)[6] = __fkg_store_tmp[2];
((double*)&force[i+0].acc.x)[9] = __fkg_store_tmp[3];
}
}

{
__m256d __fkg_tmp_accum;
alignas(32) int index_gather_load4[4] = {0,3,6,9};
__m128i vindex_gather_load4 = _mm_load_si128((const __m128i*)index_gather_load4);
__fkg_tmp_accum = _mm256_i32gather_pd(((double*)&force[i+0].acc.y),vindex_gather_load4,8);
__fkg_tmp_accum = _mm256_add_pd(__fkg_tmp_accum,ai.v1);
{
PIKG::F64 __fkg_store_tmp[4];
_mm256_storeu_pd(__fkg_store_tmp,__fkg_tmp_accum);
((double*)&force[i+0].acc.y)[0] = __fkg_store_tmp[0];
((double*)&force[i+0].acc.y)[3] = __fkg_store_tmp[1];
((double*)&force[i+0].acc.y)[6] = __fkg_store_tmp[2];
((double*)&force[i+0].acc.y)[9] = __fkg_store_tmp[3];
}
}

{
__m256d __fkg_tmp_accum;
alignas(32) int index_gather_load5[4] = {0,3,6,9};
__m128i vindex_gather_load5 = _mm_load_si128((const __m128i*)index_gather_load5);
__fkg_tmp_accum = _mm256_i32gather_pd(((double*)&force[i+0].acc.z),vindex_gather_load5,8);
__fkg_tmp_accum = _mm256_add_pd(__fkg_tmp_accum,ai.v2);
{
PIKG::F64 __fkg_store_tmp[4];
_mm256_storeu_pd(__fkg_store_tmp,__fkg_tmp_accum);
((double*)&force[i+0].acc.z)[0] = __fkg_store_tmp[0];
((double*)&force[i+0].acc.z)[3] = __fkg_store_tmp[1];
((double*)&force[i+0].acc.z)[6] = __fkg_store_tmp[2];
((double*)&force[i+0].acc.z)[9] = __fkg_store_tmp[3];
}
}
...
alignas(32) int index_gather_load6[4] = {0,5,10,15};
__m128i vindex_gather_load6 = _mm_load_si128((const __m128i*)index_gather_load6);
eps2 = _mm256_i32gather_pd(((double*)&epj[j].eps),vindex_gather_load6,8);
__m256d mj;

alignas(32) int index_gather_load7[4] = {0,5,10,15};
__m128i vindex_gather_load7 = _mm_load_si128((const __m128i*)index_gather_load7);
mj = _mm256_i32gather_pd(((double*)&epj[j].m),vindex_gather_load7,8);
__m256dx3 rj;

alignas(32) int index_gather_load8[4] = {0,5,10,15};
__m128i vindex_gather_load8 = _mm_load_si128((const __m128i*)index_gather_load8);
rj.v0 = _mm256_i32gather_pd(((double*)&epj[j].r.x),vindex_gather_load8,8);
alignas(32) int index_gather_load9[4] = {0,5,10,15};
__m128i vindex_gather_load9 = _mm_load_si128((const __m128i*)index_gather_load9);
rj.v1 = _mm256_i32gather_pd(((double*)&epj[j].r.y),vindex_gather_load9,8);
alignas(32) int index_gather_load10[4] = {0,5,10,15};
__m128i vindex_gather_load10 = _mm_load_si128((const __m128i*)index_gather_load10);
rj.v2 = _mm256_i32gather_pd(((double*)&epj[j].r.z),vindex_gather_load10,8);
__m256dx3 rij;
...
ai.v0 = _mm256_blend_pd(__fkg_tmp2.v0,ai.v0,0b00000001);
ai.v1 = _mm256_blend_pd(__fkg_tmp2.v1,ai.v1,0b00000001);
ai.v2 = _mm256_blend_pd(__fkg_tmp2.v2,ai.v2,0b00000001);
} // if of j tail loop

{
ai.v0 = _mm256_add_pd(ai.v0,_mm256_shuffle_pd(ai.v0,ai.v0,0b1111));
ai.v0 = _mm256_add_pd(ai.v0,_mm256_castpd128_pd256(_mm256_extractf128_pd(ai.v0,1)));
((double*)&force[i+0].acc.x)[0] = (((double*)&force[i+0].acc.x)[0]+ai.v0[0]);
}

{
ai.v1 = _mm256_add_pd(ai.v1,_mm256_shuffle_pd(ai.v1,ai.v1,0b1111));
ai.v1 = _mm256_add_pd(ai.v1,_mm256_castpd128_pd256(_mm256_extractf128_pd(ai.v1,1)));
((double*)&force[i+0].acc.y)[0] = (((double*)&force[i+0].acc.y)[0]+ai.v1[0]);
}

{
ai.v2 = _mm256_add_pd(ai.v2,_mm256_shuffle_pd(ai.v2,ai.v2,0b1111));
ai.v2 = _mm256_add_pd(ai.v2,_mm256_castpd128_pd256(_mm256_extractf128_pd(ai.v2,1)));
((double*)&force[i+0].acc.z)[0] = (((double*)&force[i+0].acc.z)[0]+ai.v2[0]);
}
